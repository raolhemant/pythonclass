...
# list_data = ["sudan","broadway","teaching","tt",1,2,3,4,5,6]
# index = len(list_data)-1
# print(index)
# index_number = int(input("enter index for list"))
# if (index_number>=0 and index_number<=index):
#     print(list_data[index_number])
# else:
#     print("invalid index for list")
a = [1,2,2,3,["sudan","bhandari"]]
b = a[4]
print(b[1])
#direct 
print(a[4][1])